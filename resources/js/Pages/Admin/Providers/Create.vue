...
const steps = [
    ...
    { id: 3, title: 'CONTACTO', code: 'SEC_03', icon: Users, fields: ['email_orders', 'contact_name'] },
];
...
<template>
    <AdminLayout>
        ...
        <div class="max-w-4xl mx-auto pb-40 md:pb-12 px-4 md:px-0">
            ...
            <div class="sticky top-0 z-30 bg-background/95 backdrop-blur-md border-b border-primary/30 px-4 py-4 mb-6 transition-all duration-300 group/header">
                ...
                <div class="relative z-10">
                    <div class="flex justify-between items-start mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="relative group/title">
                                ...
                                <p class="text-[10px] font-mono text-muted-foreground mt-1 flex items-center gap-2">
                                    ...
                                    <span>{{ tempCode }} // REGISTRO DE SOCIO</span>
                        ...
                        <div class="border border-cyan-500/30 bg-cyan-500/10 px-3 py-1.5 flex items-center gap-2">
                            <Wifi :size="12" class="text-cyan-500" />
                            <span class="text-[10px] font-mono font-bold text-cyan-500 uppercase">ACTIVO POR DEFECTO</span>
                        </div>
                    </div>

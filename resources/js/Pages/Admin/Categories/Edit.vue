                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <span v-if="!category.is_active" class="badge badge-error">
                                INACTIVO
                            </span>
                            ...
                            <div v-if="currentStep === 1" key="1" class="space-y-8 animate-in">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div v-if="categoryType === 'child'" 
                                        ...
                                        <label class="form-label text-primary">Mover a Categoría Padre:</label>
                                        <select v-model="form.parent_id" 
                                                class="w-full bg-card"
                                                :class="{'border-error': form.errors.parent_id}">
                                            <option value="">-- Ninguna (Convertir en padre) --</option>
                            ...
                            <div v-else-if="currentStep === 2" key="2" class="space-y-6 animate-in">
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    ...
                                    <div class="lg:col-span-1">
                                        <ImageUploader v-model="form.image" :existing-image="category.image_url" />
                                    ...
                                    <div class="lg:col-span-2 space-y-4">
                                        ...
                                        <div class="bg-muted/30 p-4 rounded-lg border border-input">
                                            ...
                                            <div class="space-y-3">
                                                <div class="form-group">
                                                    <label class="form-label text-xs">Meta Título</label>
                                                    <input v-model="form.seo_title" type="text" 
                                                           placeholder="Para resultados de búsqueda">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label text-xs">Meta Descripción</label>
                                                    <textarea v-model="form.seo_description" rows="2" 
                                                              class="resize-none"
                                                              placeholder="Descripción breve para SEO"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs font-mono text-primary mt-1">Configuración de Oferta</p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-card border border-border shadow-sm overflow-hidden relative">
                        ...
                        <div class="p-5 space-y-5">
                            ...
                            <div class="space-y-2">
                                ...
                                <input v-model="form.name" type="text" class="form-input w-full font-bold text-lg" placeholder="Ej: Pack Fin de Semana" />
                            ...
                            <div class="space-y-2">
                                ...
                                <button v-if="imagePreview" type="button" @click.stop="clearImage" class="text-[10px] text-error hover:underline flex items-center gap-1">
                                    <Trash2 :size="12"/> Eliminar imagen actual
                                </button>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea v-model="form.description" class="form-input w-full pl-10 resize-none text-sm" rows="3" placeholder="Detalles del pack..."></textarea>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input v-model="form.fixed_price" type="number" step="0.01" class="form-input w-full pl-9 font-mono text-lg font-bold" placeholder="0.00" />
                                </div>
                            </div>
                ...
                <div class="lg:col-span-12 mt-4">
                    <button type="submit" :disabled="form.processing" 
                        ...
                        <span v-else class="flex items-center gap-2">
                            <Save :size="20" /> Guardar Pack Promocional
                        </span>
                    </button>
                </div>

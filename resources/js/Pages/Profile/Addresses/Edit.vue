<script setup>
    ...
    const props = defineProps({
        address: Object,         // La dirección antigua
        activeBranches: Array    // Polígonos
    });
    ...
    const form = useForm({
        ...
        // --- CORRECCIÓN CRÍTICA ---
        // Debemos inicializar branch_id. Si no lo ponemos aquí, Inertia no lo enviará.
        branch_id: props.address.branch_id, 
    });
    
    const submit = () => {
        // Enviamos al método update.
        // Al incluir branch_id en useForm, ahora sí enviará:
        // - ID de la sucursal (si entró en zona)
        // - NULL (si salió de zona)
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                <form @submit.prevent="submit" class="p-6 md:p-8 space-y-6">
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 text-sm text-blue-700">
                        <p><strong>Nota:</strong> Al modificar la ubicación en el mapa, guardaremos esta nueva posición como tu dirección actual.</p>
                    </div>

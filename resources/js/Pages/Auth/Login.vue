<script setup>
    import { ref } from 'vue';
    // 1. IMPORTANTE: Añadimos 'Link' a los imports de Inertia
        ...
        <div class="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            ...
            <div class="mt-6 text-center">
                <Link 
                    ...
                    class="text-[10px] text-gray-400 hover:text-blue-600 font-bold uppercase underline transition-colors"
                >
                    ¿Olvidaste tu contraseña?
                </Link>
                <div>
                    <p class="text-xs text-gray-500 mb-1">¿Nuevo en BoliviaLogistics?</p>
                    <Link 
                        :href="route('register')" 
                        class="text-sm font-bold text-blue-600 hover:text-blue-800 uppercase tracking-wide border-2 border-blue-50 px-4 py-2 rounded-full hover:bg-blue-50 transition"
                    >
                        Crear Cuenta Nueva
                    </Link>
                </div>
...
<style>
/* Personalización profunda del input de teléfono */
.vue-tel-input {

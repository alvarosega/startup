...
<template>
    <label class="switch-theme">
        ...
        <span class="slider-theme">
            ...
            <svg viewBox="0 0 16 16" class="cloud-theme">
...
/* Fondo y Base (Modo Noche por Defecto) */
.slider-theme { 
    position: absolute; cursor: pointer; top: 0; left: 0; right: 0; bottom: 0; 
    background-color: #2a2a2a; transition: 0.4s; border-radius: 30px; overflow: hidden; 
}

/* El Círculo (Luna que se convierte en Sol) */
.slider-theme:before { 
    position: absolute; content: ""; height: 1.2em; width: 1.2em; border-radius: 50%; 
    left: 0.5em; bottom: 0.5em; transition: 0.4s; 
    transition-timing-function: cubic-bezier(0.81, -0.04, 0.38, 1.5); 
    box-shadow: inset 8px -4px 0px 0px #fff; /* Apariencia de Luna */
}
...
.switch-theme input:checked + .slider-theme:before { 
    ...
    box-shadow: inset 15px -4px 0px 15px #ffcf48; /* Se convierte en Sol */
}
...
/* Ocultar estrellas en día */
.switch-theme input:checked + .slider-theme .star-theme { opacity: 0; transform: translateY(10px); }

/* Nubes */
.cloud-theme { width: 3em; position: absolute; bottom: -1em; left: -0.5em; opacity: 0; transition: 0.4s; pointer-events: none; }
.switch-theme input:checked + .slider-theme .cloud-theme { opacity: 1; bottom: 0; }
</style>